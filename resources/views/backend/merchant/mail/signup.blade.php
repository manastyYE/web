    ...
    <table style="width:100%;height:50px;max-width:650px;margin: auto;">
        <tr>
            <td style="text-align: center;padding:30px 10px">
                <a href="{{ url('/') }}"><img src="{{ static_asset(@settings()->rxlogo->original) }}"
                        style="height: 50px;" /></a>
            </td>
        </tr>
    </table>
    <table style="width:100%;height:50px;max-width:650px;margin: auto;background-color: white;">
        ...
        <tr>
            <td style="width: 50%; text-align: right;padding: 10px 10px 30px 10px;">
                <a href="#"> <img src="{{ static_asset('backend/images/social-media') }}/play butttom.png"
                        style="width:200px;" /></a>
            </td>
            <td style="width: 50%;text-align: left;padding: 10px 10px 30px 10px;">
                <a href="#"><img src="{{ static_asset('backend/images/social-media') }}/istore.png"
                        style="width:200px" /></a>
            </td>
        </tr>
    </table>
    <table style="width:100%;height:50px;max-width:650px;margin: auto; ">
        <tr>
            <td style="text-align: center;">
                <ul>
                    <li> <a> <img src="{{ static_asset('backend/images/social-media') }}/brand-b.png"
                                style="width: 30px;" /> </a> </li>
                    <li> <a> <img src="{{ static_asset('backend/images/social-media') }}/brand-c.png"
                                style="width: 30px;" /> </a> </li>
                    <li> <a> <img src="{{ static_asset('backend/images/social-media') }}/brand-d.png"
                                style="width: 30px;" /> </a> </li>
                    <li> <a> <img src="{{ static_asset('backend/images/social-media') }}/brand-e.png"
                                style="width: 30px;" /> </a> </li>
                </ul>
            </td>
        </tr>
