                    ...
                    <nav class="navbar navbar-expand-lg navbar-light  fixed-top   ">
                        ...
                        <div class="dropdown lang-dropdown navbar_menus changeLocale mobileLocale ">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ route('setlocalization', 'en') }}"> <i
                                        class="flag-icon flag-icon-us"></i> {{ __('levels.english') }}</a>

                                <a class="dropdown-item" href="{{ route('setlocalization', 'ar') }}"> <i
                                        class="flag-icon flag-icon-sa"></i> {{ __('levels.arabic') }}</a>
                        ...
                        <div class=" navbar-collapse  " id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto navbar-right-top">
                                ...
                                <li class="nav-item dropdown nav-user navbar_menus">
                                    @if (hasPermission('dashboard_read') == true)
                                        <a class="dropdown-item {{ request()->is('/*') ? 'active' : '' }}"
                                            href="{{ url('/') }}" aria-expanded="false" data-target="#submenu-1"
                                            aria-controls="submenu-1"><i class="fa fa-home"></i>
                                            {{ __('menus.dashboard') }}</a>
                                    @endif
                                </li>
                                <li class="nav-item dropdown nav-user navbar_menus">
                                    @if (hasPermission('delivery_man_read') == true)
                                        <a class="dropdown-item {{ request()->is('admin/deliveryman*') ? 'active' : '' }}"
                                ...
                                {{-- hub manage --}}
                                <li class="nav-item dropdown nav-user navbar_menus">
                                    <a class="dropdown-item" href="#" id="navbarDropdownMenuLinkHubManage"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                        aria-labelledby="navbarDropdownMenuLinkHubManage">
                                        <div class="nav-user-info">
                                            <h5 class="mb-0 text-white nav-user-name">{{ __('menus.hub_mange') }}</h5>
                                        </div>
                                        @if (hasPermission('hub_read') == true)
                                            <a class="dropdown-item {{ request()->is('admin/hubs*', 'admin/hub*') ? 'active' : '' }}"
                                                href="{{ route('hubs.index') }}">{{ __('menus.hubs') }}</a>
                                        @endif
                                        @if (hasPermission('hub_payment_read') == true)
                                            <a class="dropdown-item {{ request()->is('admin/request/hub/payment*') ? 'active' : '' }}"
                                                href="{{ route('hub.hub-payment.index') }}">{{ __('menus.payments') }}</a>
                                        @endif
                                    </div>
                                </li>
                                <li class="nav-item dropdown nav-user navbar_menus">
                                    <a class="dropdown-item" href="#" id="navbarDropdownMenuLinkMerchantManage"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <div class="d-flex justify-content-between">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                        aria-labelledby="navbarDropdownMenuLinkMerchantManage">
                                        <div class="nav-user-info">
                                            <h5 class="mb-0 text-white nav-user-name">
                                                {{ __('menus.merchant_manage') }}</h5>
                                        </div>

                                        @if (hasPermission('merchant_read') == true || hasPermission('payment_read') == true)
                                            @if (hasPermission('merchant_read') == true)
                                                <a class="dropdown-item {{ request()->is('admin/merchant*') ? 'active' : '' }}"
                                            ...
                                            @if (hasPermission('payment_read') == true)
                                                <a class="dropdown-item {{ request()->is('admin/payment*') ? 'active' : '' }}"
                                                    href="{{ route('merchant.manage.payment.index') }}">Payments</a>
                                            @endif
                                        @endif
                                    </div>
                                </li>
                                ...
                                <li class="nav-item dropdown nav-user navbar_menus">
                                    @if (hasPermission('todo_read') == true)
                                        <a class="dropdown-item {{ request()->is('admin/todo/todo_list*') ? 'active' : '' }}"
                                            href="{{ route('todo.index') }}" aria-expanded="false"
                                            data-target="#hubs" aria-controls="hubs"><i class="fas fa-tasks"></i>
                                            {{ __('menus.todo_list') }}</a>
                                    @endif
                                </li>
                                <li class="nav-item dropdown nav-user navbar_menus">
                                    @if (hasPermission('support_read') == true)
                                        <a class="dropdown-item {{ request()->is('admin/support*') ? 'active' : '' }}"
                                            href="{{ route('support.index') }}" aria-expanded="false"
                                            data-target="#hubs" aria-controls="hubs"><i class="fa fa-comments"></i>
                                            {{ __('menus.support') }}</a>
                                    @endif
                                </li>
                                <li class="nav-item dropdown nav-user navbar_menus">
                                    @if (hasPermission('parcel_read') == true)
                                        <a class="dropdown-item {{ request()->is('admin/parcel*') ? 'active' : '' }}"
                                            href="{{ route('parcel.index') }}" aria-expanded="false"
                                            data-target="#submenu-1" aria-controls="submenu-1"><i
                                                class="fa fa-dolly"></i> {{ __('menus.parcel') }}</a>
                                    @endif
                                    @if (hasPermission('news_offer_read') == true)
                                        <a class="dropdown-item {{ request()->is('admin/news-offer*') ? 'active' : '' }}"
                                            href="{{ route('news-offer.index') }}"><i class="fa fa-newspaper "
                                                style="margin-right: 10px!important"></i>
                                            {{ __('menus.news_offer') }}</a>
                                    @endif
                                    @if (hasPermission('log_read') == true)
                                        <a class="dropdown-item {{ request()->is('admin/logs*') ? 'active' : '' }}"
                                            href="{{ route('logs.index') }}" aria-expanded="false"
                                    ...
                                    @if (hasPermission('fraud_read') == true)
                                        <a class="dropdown-item {{ request()->is('admin/fraud*') ? 'active' : '' }}"
                                ...
                                <li class="nav-item dropdown nav-user navbar_menus">
                                    @if (hasPermission('subscribe_read') == true)
                                        <a class="dropdown-item{{ request()->is('admin/subscribe*') ? 'active' : '' }}"
                                ...
                                @if (hasPermission('pickup_request_regular') == true || hasPermission('pickup_request_express') == true)
                                    <li class="nav-item dropdown nav-user navbar_menus">
                                        <a class="dropdown-item {{ request()->is('admin/pickup-request*') ? 'active' : '' }}"
                                            href="#" id="navbarDropdownMenuLinkPickupRequest"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">

                                            <div class="d-flex justify-content-between">
                                                <span> <i
                                                        class="fa fa-truck-moving"></i>{{ __('menus.pickup_request') }}</span>
                                                <span><i class="fa fa-angle-down"></i></span>
                                            </div>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                            ...
                                            <ul class="nav flex-column">
                                                @if (hasPermission('pickup_request_regular') == true)
                                                    <a class="dropdown-item  {{ request()->is('admin/pickup-request/regular*') ? 'active' : '' }}"
                                                        href="{{ route('pickup.request.regular') }}">{{ __('menus.regular') }}</a>
                                                @endif
                                                @if (hasPermission('pickup_request_express') == true)
                                                    <a class="dropdown-item {{ request()->is('admin/pickup-request/express*') ? 'active' : '' }}"
                                ...
                                <li class="nav-item dropdown nav-user navbar_menus">
                                    @if (hasPermission('assets_read') == true)
                                        <a class="dropdown-item {{ request()->is('admin/assets*') ? 'active' : '' }}"
                                            href="{{ route('asset.index') }}" aria-expanded="false"
                                            data-target="#hubs" aria-controls="hubs"><i
                                                class="fa fa-fw fa-users"></i> {{ __('menus.assets') }}</a>
                                    @endif
                                </li>
                                ...
                                <li class="nav-item dropdown nav-user navbar_menus">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                        ...
                                        @if (hasPermission('account_heads_read') == true)
                                            <a class="dropdown-item {{ request()->is('admin/account-heads*') ? 'active' : '' }}"
                                        ...
                                        @if (hasPermission('cash_received_from_delivery_man_read') == true)
                                            @if (Auth::user()->hub_id)
                                                <a class="dropdown-item {{ request()->is('admin/hub/cash-received-deliveryman*') ? 'active' : '' }}"
                                        ...
                                        @if (hasPermission('hub_payment_request_read') == true)
                                            @if (auth()->user()->hub_id)
                                                <a class="dropdown-item {{ request()->is('admin/hub/payment-request*') ? 'active' : '' }}"
                                ...
                                <li class="nav-item dropdown nav-user navbar_menus">
                                    <a class="dropdown-item" href="#" id="navbarDropdownMenuLinkUserRole"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <div class="d-flex justify-content-between">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                        aria-labelledby="navbarDropdownMenuLinkUserRole">
                                        <div class="nav-user-info">
                                            <h5 class="mb-0 text-white nav-user-name">{{ __('menus.user_role') }}
                                            </h5>
                                        </div>
                                ...
                                <li class="nav-item dropdown nav-user navbar_menus">
                                    <a class="dropdown-item" href="#" id="navbarDropdownMenuLinkPayroll"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <div class="d-flex justify-content-between">
                                            <span><i class="fas fa-hand-holding-usd"></i>
                                                {{ __('salary.payroll') }}</span>
                                            <span><i class="fa fa-angle-down"></i></span>
                                        </div>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                        aria-labelledby="navbarDropdownMenuLinkPayroll">
                                        <div class="nav-user-info">
                                        ...
                                        @if (hasPermission('salary_generate_read') == true || hasPermission('salary_read') == true)
                                            @if (hasPermission('salary_generate_read') == true)
                                                <a class="dropdown-item {{ request()->is('admin/salary/salary-generate*', 'admin/reports/parcel-filter-reports') ? 'active' : '' }}"
                                            ...
                                            @if (hasPermission('salary_read') == true)
                                                <a class="dropdown-item {{ request()->is('admin/salarys*') ? 'active' : '' }}"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                        ...
                                        @if (hasPermission('parcel_status_reports') == true || hasPermission('parcel_wise_profit') == true)
                                            @if (hasPermission('parcel_status_reports') == true)
                                                <a class="dropdown-item {{ request()->is('admin/reports/parcel-reports*', 'admin/reports/parcel-filter-reports') ? 'active' : '' }}"
                                            ...
                                            @if (hasPermission('parcel_wise_profit') == true)
                                                <a class="dropdown-item {{ request()->is('admin/reports/parcel-wise*') ? 'active' : '' }}"
                                                    href="{{ route('parcel.wise.profit.index') }}">{{ __('reports.parcel_wise_profit') }}</a>
                                            @endif
                                            @if (hasPermission('salary_reports') == true)
                                                <a class="dropdown-item {{ request()->is('admin/reports/salary-reports*', 'admin/reports/reports-salary-reports*') ? 'active' : '' }}"
                                                    href="{{ route('salary.reports') }}">{{ __('reports.salary_reports') }}</a>
                                            @endif
                                            @if (hasPermission('merchant_hub_deliveryman') == true)
                                                <a class="dropdown-item {{ request()->is('admin/reports/merchant-hub-deliveryman*', 'admin/reports/mhd-reports') ? 'active' : '' }}"
                                            ...
                                            @if (hasPermission('parcel_total_summery') == true)
                                                <a class="dropdown-item {{ request()->is('admin/reports/parcel-total-summery*', 'admin/reports/parcel-filter-total-summery*') ? 'active' : '' }}"
                                ...
                                @if (hasPermission('push_notification_read') == true)
                                    <li class="nav-item dropdown nav-user navbar_menus">
                                        <a class="dropdown-item {{ request()->is('admin/push-notification*') ? 'active' : '' }}"
                                ...
                                <li class="nav-item dropdown nav-user d-lg-block">
                                    <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2"
                                        ...
                                        <img src="{{ Auth::user()->image }}" alt=""
                                            class="user-avatar-md rounded-circle" style="object-fit: contain">
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                        ...
                                        <a class="dropdown-item"
                                            href="{{ route('profile.index', Auth::user()->id) }}"><i
                                                class="fas fa-user mr-2"></i>{{ __('menus.profile') }}</a>
                                        <a class="dropdown-item"
                                            href="{{ route('password.change', Auth::user()->id) }}"><i
